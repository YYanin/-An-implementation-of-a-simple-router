...
class final_topo(Topo):
  def build(self):
    ...
    #Trusted host
    self.addLink(s5,h_trust, port1=3, port2=0)
    #Untrusted host
    self.addLink(s5,h_untrust, port1=4, port2=0)
    #Floor 2 switches
    self.addLink(s5,s3, port1=5, port2=3)
    self.addLink(s5,s4, port1=6, port2=3)

    #Data center
    self.addLink(s6,s5, port1=1, port2=7)
